                ...
                <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css" />
                 <form className="one" onSubmit = {this.handleSubmit}>
                    <div className="segment">
                      ...
                      <button className="red" type="submit"> <i className="fa fa-lock" aria-hidden="true" />Log in</button>

                      <div className="segment">
                       <button className="unit" type="button"> <i className="fa fa-arrow-left" aria-hidden="true" /> </button>
