...
import {getJwt} from '../auth/helpers'
                    ...
                    <div>
                            ...
                            <div className="super-containerLog">
                                <div className="left-content-containerLog">
                                    <div className="quote">
                                    <p> “ Reality must be more beautiful, honest and clear than   <span>imagination</span>. ” </p>
                                    </div>                             
                                        <div className="content">
                                        <p> Hello .. plesee enter you email and password!{this.state.loged} </p>
